    ...
    class Group
    {
        ...
        public static void ShowStudentsinGroup()
        {
            ...
            foreach (var item in groups)
            {
                ...
                {
                    foreach (var Student in Student.studs)
                    {
                        if (Student.StudentGroupNo == GroupNo)
                        {
                            Console.WriteLine("Show Students in this Group");
                            //Student.ShowAllStudents();
                            Console.WriteLine($"{Student.FullName} {Student.StudentGroupNo}");
                        }
                        else if (Student.StudentGroupNo == null)
                        {
